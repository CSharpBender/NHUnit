...
namespace NHUnit
{
    public interface IMultipleEntityWrapper<T> where T : class, new()
    {
        /// <summary>
        ...
        /// <returns></returns>
        IMultipleEntityWrapper<T> Include(params Expression<Func<T, object>>[] includeChildNodes);
        ...
        /// </summary>
        /// <returns></returns>
        IMultipleEntityWrapper<T> Unproxy();
        ...
        /// </summary>
        /// <returns></returns>
        IMultipleEntityWrapper<T> Deferred();
        ...
        /// <returns></returns>
        Task<List<T>> ListAsync(CancellationToken token = default(CancellationToken));
    }
}
